...
public class UsuarioDAO {
    ...
    /**
     * Crea un nuevo usuario en la base de datos con ID específico
    ...
    /**
     * Crea un nuevo usuario en la base de datos (método original)
    ...
    public boolean crearUsuario(Usuario u) {
        ...
        try {
            conn = ConexionDB.getConexion();
            System.out.println("Creando usuario: " + u.getNombre() + ", " + u.getCorreo());
