...
<head>
    ...
    <title>Crear Usuario - EA04</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm mb-4">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link active" href="crear-usuario.jsp">
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="usuarios" method="POST" id="formularioCrear">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre" 
                                           value="${param.nombre}" required maxlength="50"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="apellido" name="apellido" 
                                           value="${param.apellido}" required maxlength="50"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="telefono" name="telefono" 
                                       value="${param.telefono}" required maxlength="15"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="direccion" name="direccion" 
                                          ...
                                          placeholder="Ingrese su dirección completa">${param.direccion}</textarea>
